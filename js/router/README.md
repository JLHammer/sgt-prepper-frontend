...
Denne router er en _hash-router_ og skrevet særligt til dette projekt. Det betyder at vi arbejder med nogle lidt specielle url'er:
...
http://127.0.0.1:5500/index.html#/cart
```
